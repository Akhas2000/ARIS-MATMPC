function [controls_MPC, state_sim, time, data]  = Simulation_Scale(settings,opt,N,Ns,q_sv,q_p,q_h,q_v,q_rot,q_omega,h_UAV,pathXY_ProxyUtility,Tf_init,T_stabilization)
...
if opt.nonuniform_grid
    ...
    [input, data]  = InitData_Scale(settings,Ns,q_sv,q_p,q_h,q_v,q_rot,q_omega,h_UAV,pathXY_ProxyUtility);
