function [controls_MPC, state_sim, time, data, solve_time]  = Simulation_Scale(settings,opt,N,Ns,sv_init,sv_max,q_sv,q_p,q_h,q_v,q_rot,q_omega,h_UAV,pathXY_ProxyUtility,Tf_init,...
...
if opt.nonuniform_grid
    ...
    [input, data]  = InitData_Scale(settings,Ns,sv_init,sv_max,q_sv,q_p,q_h,q_v,q_rot,q_omega,h_UAV,pathXY_ProxyUtility);
end  
